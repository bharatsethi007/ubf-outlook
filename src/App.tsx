...
import { readCurrentEmail, type EmailData } from '@/lib/office'
...
export default function App() {
  ...
  async function handleSend() {
    if (!email) return
    setSending(true)
    // Backend wiring (quote-from-email Edge Function) lands in Step 2.
    setTimeout(() => {
      setSending(false)
      toast.info('Backend not connected yet — that\u2019s the next step.')
    }, 400)
  }
